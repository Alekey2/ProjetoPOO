 ...
 */
package src.main.java.com.allset.gestaovenda.modelo.dao;
...
import src.main.java.com.allset.gestaovenda.modelo.entidades.PERFIL;
...
public class UsuarioDao {
    ...
    private String adicionar(Usuario usuario) {
        ...
        if(usuarioTemp != null) {
            return String.format("Error: username %s already exists in the database", usuario.getUsername());
        }
        ...
        try {
            ...
            return resultado == 1 ? "User added successfully." : "Could not add user";
    ...
    private String editar(Usuario usuario) {
        ...
        try {
            ...
            return resultado == 1 ? "User edited successfully." : "Could not edit user";
        } catch (SQLException e) {
            return String.format("Error: %s", e.getMessage());
        }
    }
    ...
    public String deleteUsuarioPeloId(Long id) {
        ...
        try {
            ...
            return resultado == 1 ? "User deleted successfully" : "Could not delete user";
    ...
    public void actualizarUltimoLogin(Usuario usuario) {
        ...
        try {
            ...
            System.out.println(String.format("Last login update: %s", 
                    resultado == 1 ? "Successful!!!" : "Unsuccessful."));            
        } catch (SQLException e) {
            System.out.println(String.format("Error: %s", e.getMessage()));
        }
    }
